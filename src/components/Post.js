...
export default function Post({id, question, imgUrl, timestamp, quoraUser}) {
  ...
  Modal.setAppElement(document.getElementById('root')); // add Modal to the root element
  ...
  //     const res=fetch("https://quora-clone-2e62a-default-rtdb.firebaseio.com/.json",{
  //      method:"POST",
  //      headers:{"Content-Type":"application.json"},
  //      body:JSON.stringify({   // https://quora-clone-2e62a-default-rtdb.firebaseio.com/
  //        title,
  //        image,
  //        description
  //      })
    ...
    dispatch(setQuestionInfo({
      ...
      >
           <div className="modal__question">
            ...
            <img src="https://s2-recruiting.cdn.greenhouse.io/external_greenhouse_job_boards/logos/400/770/100/original/QuoraLogoForGreenhouse_3.png?1572319612" //image inserted for post 
              alt='imgURL' />
        </div>
